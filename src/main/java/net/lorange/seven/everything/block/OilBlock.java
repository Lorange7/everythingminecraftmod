...
public class OilBlock extends EverythingModElements.ModElement {
	@ObjectHolder("everything:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("everything:oil_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public OilBlock(EverythingModElements instance) {
		super(instance, 2);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("everything:blocks/oil"), new ResourceLocation("everything:blocks/oil")).luminosity(0)
						.density(1500).viscosity(1000)).bucket(() -> bucket).block(() -> block);
		...
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(PetrolItemGroup.tab))
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("everything:oil_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
