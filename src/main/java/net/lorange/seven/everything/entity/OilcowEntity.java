...
package net.lorange.seven.everything.entity;
...
import net.lorange.seven.everything.particle.OilishstuffParticle;
...
public class OilcowEntity extends EverythingModElements.ModElement {
	public static EntityType entity = null;
	public OilcowEntity(EverythingModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("oilcow")
						.setRegistryName("oilcow");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -16777216, new Item.Properties().group(PetrolItemGroup.tab))
				.setRegistryName("oilcow_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 20, 1, 6));
	}
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new CowModel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("everything:textures/cow.png");
				}
			});
		}
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, PigEntity.class, true, true));
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 1));
			this.goalSelector.addGoal(3, new FollowMobGoal(this, (float) 1, 10, 5));
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, PillagerEntity.class, false, true));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(PetroliumspiritItem.block, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 5; ++l) {
					...
					world.addParticle(OilishstuffParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
