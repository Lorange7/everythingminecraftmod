...
public class MachinebowItem extends EverythingModElements.ModElement {
	@ObjectHolder("everything:machinebow")
	public static final Item block = null;
	@ObjectHolder("everything:entitybulletmachinebow")
	public static final EntityType arrow = null;
	public MachinebowItem(EverythingModElements instance) {
		super(instance, 18);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletmachinebow").setRegistryName("entitybulletmachinebow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(900));
			setRegistryName("machinebow");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("a fully automatic bow"));
		}
