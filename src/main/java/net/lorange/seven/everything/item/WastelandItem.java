...
import net.lorange.seven.everything.world.dimension.WastelandDimension;
import net.lorange.seven.everything.itemgroup.NanoroboticsItemGroup;

public class WastelandItem extends Item {
	@ObjectHolder("everything:wasteland")
	public static final Item block = null;
	public WastelandItem() {
		super(new Item.Properties().group(NanoroboticsItemGroup.tab).maxDamage(64));
	}
