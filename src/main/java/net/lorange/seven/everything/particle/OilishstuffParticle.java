...
package net.lorange.seven.everything.particle;
...
public class OilishstuffParticle extends EverythingModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public OilishstuffParticle(EverythingModElements instance) {
		super(instance, 6);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("oilishstuff"));
	}
