...
package net.lorange.seven.everything.keybind;
...
public class FlyKeyBinding extends EverythingModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public FlyKeyBinding(EverythingModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		keys = new KeyBinding("key.everything.fly", GLFW.GLFW_KEY_SPACE, "key.categories.movement");
